...
|       `dynamic`      | If you would like to use dynamic render_data in your contract, you must set this to true. If this is set to true, you MUST also pass an object into the `renderData` prop.                                                                                                                                                                                                        |                                     bool                                     |                      No                     |                     false                    |
...
|     `renderData`     | Object containing the dynamic render data for your contract. When using this prop, the `dynamic` prop must be set to `true`. [For more information on using dynamic contracts, check out this documentation.](https://developer.pactsafe.com/docs/how-to-use-smart-contracts-with-the-javascript-library)                                                                                                                                          |                                    object                                    |         If `dynamic` is set to true         |                   undefined                  |
